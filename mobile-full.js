/* 
*   Used to forward all mobile visitors to the mobile site 
*   and to allow them to view the full site
*	IMPORTANT! Modify lines 140, 145, 146 and 165 with your full & mobile sites URLs
*/
...
var mobilesite = "http://m.mobileSite.com/"; 
var locationhref = removeQueryString(location.href);
 
	//alert("location href after: " + locationhref);
 
if (locationhref == "http://www.yourFullSite.com/") { 
mobilesite = "http://m.mobileSite.com/";
...
document.cookie = curName + "=" + escape(window.location.href) + "[#]contentid=" + document.getElementById("inputContentID").value + "[#]title=" + GetPageTitle() + ";expires=" + exdate.toGMTString() + ";path=/;domain=www.yourFullSite.com/;";
